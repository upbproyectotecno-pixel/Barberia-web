...
<section id="sedes" class="contenedor">
  ...
  <div class="grid">
    <div class="card">
      ...
      <a class="btn btn--link" target="_blank" href="https://maps.google.com/?q=Cra. 72 #97-122, Castilla, Medellín, Castilla, Medellín, Antioquia">Ver mapa</a>
    </div>
    <div class="card">
      ...
      <p>Cra. 50 #38a-185</p>
      <p>Lun–Sáb: 9:00–19:00</p>
      <a class="btn btn--link" target="_blank" href="https://maps.google.com/?q=Cra. 50 #38a-185, Rincon Santos, Bello, Antioquia">Ver mapa</a>
    </div>
    <div class="card">
      <img src="img/sedes/sur.jpg.jpg" alt="Sede Suroccidental" />
      <h3>Sede Suroccidental</h3>
      <p>Av. 33 #66B-81</p>
      <p>Lun–Sáb: 9:00–19:00</p>
      <a class="btn btn--link" target="_blank" href="https://maps.google.com/?q=Av. 33 #66B-81, Medellín, Belén, Medellín, Antioquia">Ver mapa</a>
    </div>
  </div>
</section>
...
<section id="redes" class="contenedor seccion-oscura">
  ...
  <ul class="social-list">
    <li><a target="_blank" href="https://www.instagram.com/barber_slot/">📸 Instagram</a></li>
    <li><a target="_blank" href="https://wa.me/573216378978">💬 WhatsApp</a></li>
  </ul>
</section>
...
<section id="contacto" class="contenedor">
  ...
  <div class="contacto-grid">
    <div class="contacto-card">
      ...
      <p>📞 <a href="tel:+573216378978">+57 3216378978</a></p>
      <p>⏰ Lun–Sáb: 9:00–19:00</p>
    ...
    <div class="contacto-card">
      ...
      <p>Calle 10 #5-20</p>
      <a class="btn btn--link" target="_blank" href="https://maps.google.com/?q=Av. 33 #66B-81">Cómo llegar</a>
    </div>
  </div>
</section>
